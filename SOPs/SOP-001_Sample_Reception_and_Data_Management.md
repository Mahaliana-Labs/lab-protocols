...
Each submitted sample receives a unique code: **XXXYY.ZZ**
  * XXX:	Location or source abbreviation	(PIV for Plateforme d'Information Vétérinaire which is used for all samples submitted by clinician veterinarian working on domestic animals; BET for sample from Betampona Natural Reserve; etc)
